...
export class WebGPURenderer {
    ...
    renderFrame(source: HTMLVideoElement | VideoFrame, params: WebGPUTransformParams = {}): void {
        if (
            !this.device ||
            !this.context ||
            !this.pipeline ||
        ...
        if (source instanceof VideoFrame && (source.format === null || source.codedWidth === 0))
            return
