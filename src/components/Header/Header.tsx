            ...
            <header className={styles.header}>
                <div className={styles.leftGroup}>
                    ...
                    <div className={styles.logo}>
                        <div className={styles.logoBadge}>
                            ...
                            >
                                ...
                                <polygon points="36,26 36,74 76,50" fill="url(#veditLogoGrad)" />
                            </svg>
                        </div>
                    ...
                    <div
                        ...
                        title={
                            gpuActive
                                ? 'WebGPU Hardware Shader Acceleration Active'
                                : 'FFmpeg WASM Engine Active'
                        }
                    >
                        {gpuActive ? (
                            <>
                    ...
                    <div className={styles.saveStatus}>
                        ...
                        {saveStatus === 'saved' && (
                            <div
                                ...
                                title="All edits saved locally to OPFS storage"
                            >
