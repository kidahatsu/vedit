                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.section}>
                        ...
                        <p className={styles.featureDesc} style={{ margin: 0 }}>
                            VEdit is a 100% private, client-side video editor. None of your videos,
                            audio, or metadata are ever uploaded to an external server. All AI
                            models and video processing run locally on your device.
                        </p>
                    </div>
                </div>
            </div>
