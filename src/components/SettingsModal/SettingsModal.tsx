...
export function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
    ...
    const handleClearStorage = async () => {
        if (
            !window.confirm(
                'Are you sure you want to clear all locally cached project data and temporary files? This will reset the workspace.'
            )
        ) {
            return
        }
                    ...
                    <div className={styles.section}>
                        ...
                        <div className={styles.row}>
                            <div className={styles.rowInfo}>
                                ...
                                <span className={styles.rowSub}>
                                    Includes IndexedDB project state & OPFS media assets
                                </span>
                            </div>
                        ...
                        <div className={styles.row}>
                            <div className={styles.rowInfo}>
                                ...
                                <span className={styles.rowSub}>
                                    Purge cached video buffers and reset editor state
                                </span>
                            </div>
                            <button
                    ...
                    <div className={styles.section}>
                        ...
                        <div className={styles.row}>
                            <div className={styles.rowInfo}>
                                ...
                                <span className={styles.rowSub}>
                                    Hardware-accelerated shader transforms & Whisper AI
                                </span>
                            </div>
                            <span
                                className={`${styles.badge} ${hasWebGPU ? styles.badgeActive : ''}`}
                            >
                        ...
                        <div className={styles.row}>
                            <div className={styles.rowInfo}>
                                ...
                                <span className={styles.rowSub}>
                                    Low-latency frame decoding & encoding
                                </span>
                            </div>
                            <span
                                className={`${styles.badge} ${typeof window !== 'undefined' && 'VideoEncoder' in window ? styles.badgeActive : ''}`}
                            >
                    ...
                    <div className={styles.section}>
                        ...
                        <div className={styles.row}>
                            <div className={styles.rowInfo}>
                                ...
                                <span className={styles.rowSub}>
                                    Pure client-side WebAssembly sandbox
                                </span>
                            </div>
