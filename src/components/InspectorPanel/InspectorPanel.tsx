 ...
 * Styled with dark glass aesthetics, WCAG 2.1 AA accessibility, and real-time WebGPU feedback.
 */
...
export function InspectorPanel() {
    ...
    const handleFixVisibility = async () => {
        ...
        try {
            ...
            const newFile = new File(
                [convertedBlob],
                selectedClip.name.replace(/\.[^.]+$/, '') + '_h264.mp4',
                {
                    type: 'video/mp4',
                }
            )
    ...
    const handleReverse = async () => {
        ...
        try {
            ...
            const reversedFile = new File([reversedBlob], `reversed_${selectedClip.name}`, {
                            ...
                            <div className={styles.aspectGrid}>
                                {ASPECT_RATIOS.map((ar) => (
                                    ...
                                    >
                                        ...
                                        />
                                        <span className={styles.aspectCardLabel}>
                                            {ar.label.split(' ')[0]}
                                        </span>
                                    </button>
                                ))}
                        ...
                        <div className={styles.section}>
                            ...
                            <div className={styles.controlRow}>
                                <div className={styles.controlHeader}>
                                    ...
                                    <span className={styles.controlValue}>
                                        {(transform.fadeIn ?? 0).toFixed(1)}s
                                    </span>
                                </div>
                                <input
                                    type="range"
                            ...
                            <div className={styles.controlRow}>
                                <div className={styles.controlHeader}>
                                    ...
                                    <span className={styles.controlValue}>
                                        {(transform.fadeOut ?? 0).toFixed(1)}s
                                    </span>
                                </div>
                                <input
                                    type="range"
                    ...
                    <div role="tabpanel" id="panel-ai" aria-labelledby="tab-ai">
                        <div className={styles.aiCard}>
                            ...
                            <p className={styles.aiCardDesc}>
                                Automatically detects pauses, silence, and speech gaps using
                                client-side Voice Activity Detection (VAD) and adds split markers to
                                timeline.
                            </p>
                            <button
                        ...
                        <div className={styles.aiCard}>
                            ...
                            <p className={styles.aiCardDesc}>
                                Generates speech-to-text transcriptions with time-aligned cues
                                directly on your GPU via OpenAI Whisper WebGPU and exports .srt
                                file.
                            </p>
                            <button
                                className={styles.aiActionBtn}
                        ...
                        <div className={styles.aiCard}>
                            ...
                            <p className={styles.aiCardDesc}>
                                Transcodes unsupported codecs (HEVC / ProRes) to standard
