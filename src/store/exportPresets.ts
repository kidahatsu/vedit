 ...
 */
export function exceedsMaxDuration(preset: ExportPreset, videoDuration: number): boolean {
 ...
 */
export function getDurationWarning(preset: ExportPreset, videoDuration: number): string | null {
