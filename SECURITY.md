...
2. Submit a confidential report via [GitHub Private Vulnerability Reporting](https://github.com/kidahatsu/vedit/security/advisories/new)
3. Maintainers will coordinate validation, CVE assignment if applicable, and patch deployment prior to public disclosure.
